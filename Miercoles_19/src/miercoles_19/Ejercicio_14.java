 ...
 * @author Alumno
 */
public class Ejercicio_14 extends javax.swing.JFrame {
    ...
    private void menuAbrirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuAbrirActionPerformed
        ...
        if(resp==JFileChooser.APPROVE_OPTION){
            ...
            JOptionPane.showMessageDialog(null,"Se pulso la opcion Cancelar");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ejercicio_14.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
